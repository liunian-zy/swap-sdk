...
var import_swap_sdk_core8 = require("@pancakeswap/swap-sdk-core");
...
var Fetcher = class {
  ...
  static async fetchTokenData(chainId, address, provider = (0, import_providers.getDefaultProvider)((0, import_networks.getNetwork)(chainId)), symbol, name) {
    ...
    return new import_swap_sdk_core8.Token(chainId, address, parsedDecimals, symbol, name);
  }
  /**
  ...
  static async fetchPairData(tokenA, tokenB, provider = (0, import_providers.getDefaultProvider)((0, import_networks.getNetwork)(tokenA.chainId))) {
    (0, import_tiny_invariant7.default)(tokenA.chainId === tokenB.chainId, "CHAIN_ID");
    ...
    return new Pair(
      import_swap_sdk_core8.CurrencyAmount.fromRawAmount(tokenA, balances[0]),
      import_swap_sdk_core8.CurrencyAmount.fromRawAmount(tokenB, balances[1])
    );
  }
};
...
0 && (module.exports = {
  ...
  isTradeBetter,
  tradeComparator,
  ...require("@pancakeswap/swap-sdk-core")
});
