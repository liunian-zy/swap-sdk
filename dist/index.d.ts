...
declare abstract class Fetcher {
     ...
     */
    static fetchTokenData(chainId: ChainId, address: string, provider: _ethersproject_providers.BaseProvider | undefined, symbol: string, name?: string): Promise<Token>;
    /**
